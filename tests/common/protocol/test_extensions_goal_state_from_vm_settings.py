...
class ExtensionsGoalStateFromVmSettingsTestCase(AgentTestCase):
    ...
    def test_it_should_parse_encoded_signature_plugin_property(self):
        data_file = wire_protocol_data.DATA_FILE_VM_SETTINGS.copy()
        # This vm settings extensions goal state has 1 extension without encodedSignature property (LinuxPatchExtension)
        # and 1 extension with encodedSignature property (NullExtension)
        data_file["vm_settings"] = "hostgaplugin/vm_settings-plugin_encoded_signature.json"
